package com.example.firesystemcs.utils;
...
public class Recorder implements Runnable {
    public String stream_url = "rtmp://58.200.131.2:1935/livetv/hunantv";// 流地址 例如：rtmp://58.200.131.2:1935/livetv/hunantv 湖南卫视
    ...
    public void run() {
        ...
        try {
            ...
            if (frame != null) {
                System.out.println("成功获取流，开始录制，时长:" + times_sec + "秒(0为没有限制录制时长)");
                //保存到本地的文件
    ...
    public static void main(String[] args) {
        Recorder recordVideoThread = new Recorder();
